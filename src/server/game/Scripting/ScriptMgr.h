...
public:
    virtual ~AIOScript()
    {
        AIOScript::_scriptByKeyMap.erase(GetKey());
    }
...
protected:
    ...
    {
        _handlerMap[handlerKey] = std::move(function);
    }
...
private:
    ...
    struct InitHookInfo
    {
        ...
        InitHookInfo(const LuaVal &scriptKey, const LuaVal &handlerKey) : scriptKey(scriptKey), handlerKey(handlerKey)
        {}
    };
