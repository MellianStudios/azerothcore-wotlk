...
struct AIOAddon
{
    ...
    AIOAddon(std::string addonName, std::string addonFile, const AccountTypes type = SEC_PLAYER)
        : name(std::move(addonName)), file(std::move(addonFile)), crc(0), accountType(type)
    {}
};
